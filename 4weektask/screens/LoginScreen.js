...
const LoginScreen=({icon, text ,value1,value2})=> {
    ...
    const [email, setEmail] = React.useState(value1);
    const [password, setPassword] = useState(value2);
  ...
  <TextInputs  icon ='email' placeholder='Email'  >{value1}</TextInputs>
  <TextInputs  icon ='lock' placeholder='Password' secureTextEntry={true}>{value2}</TextInputs>
